...
class StoreBookRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'shelf.required'         => 'وارد کردن شماره الماری ضروری می‌باشد.',
            'total.required'         => 'تعداد نسخه‌ها ضروری می‌باشد.',
            'total.integer'          => 'تعداد نسخه‌ها باید عدد باشد.',
            'total.min'              => 'حداقل تعداد نسخه‌ها باید 1 باشد.',
            'image.required'         => 'آپلود عکس کتاب ضروری می‌باشد.',
            ...
            'pdf.required'           => 'اپلود pdf ضروری می باشد',
            'borrow.prohibited' => 'کتاب‌های PDF قابل امانت گرفتن نیستند.',
            'sec_id.prohibited' => 'برای کتاب‌های PDF انتخاب الماری ضروری نمی‌باشد.',
            'shelf.prohibited' => 'برای کتاب‌های PDF تعیین شماره الماری ضروری نمی‌باشد.',
            'total.prohibited' => 'برای کتاب‌های PDF وارد کردن تعداد کاپی‌ها ضروری نمی‌باشد.',
